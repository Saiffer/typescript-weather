            ...
            <div className="container">
                ...
                <div className="level" style={{alignItems: 'flex-start'}}>
                    <div className="level-item has-text-centered">
                        <div>
                            <p className="headgin">{data.weather[0].description}</p>
                    ...
                    <div className="level-item has-text-centered">
                        ...
                        <div className="title">
                            ...
                            <p className="mb-2">{celsius}C<sup>&#8451;</sup></p>
                            <p className="mb-2">{fahrenheit}F<sup>&#8457;</sup></p>
                        </div>
                        </div>
                    </div>
                    <div className="level-item has-text-centered">
                        <div>
                            <p className="headging">Humidity</p>
                            <p className="title">{data.main.humidity}</p>
                        </div>
                    </div>
                    <div className="level-item has-text-centered">
                        <div>
                            <p className="headging">Pressure</p>
                            <p className="title">{data.main.pressure}</p>
                        </div>
                    </div>
                    <div className="level-item has-text-centered">
                        <div>
                            <p className="headging">Wind</p>
